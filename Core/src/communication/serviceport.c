...
static Command_t commands[] = {
    ...
    CMD_PARAM_ENTRY("PSG", set_temp_low_thr_param),                                          // 设置电机温度阈值 低温
    ...
    CMD_READ_FLOAT("PRG", "MotorTempLowThr+%.1f", glob_value.paramCfg.temp.low_threshold),   // 读取电机温度阈值 低温
    CMD_READ_FLOAT("PRH", "MotorTempHighThr+%.1f", glob_value.paramCfg.temp.high_threshold), // 读取电机温度阈值 高温
