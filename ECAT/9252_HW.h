...
///////////////////////////////////////////////////////////////////////////////
// LAN9252 (direct) register access via SPI (CSR/PRAM)
...
#define PRAM_RW_BUSY_8B     (1UL << 7)
#define PRAM_SET_READ       (1UL << 6)
#define PRAM_SET_WRITE      (0UL)

///////////////////////////////////////////////////////////////////////////////
// SSC timer define (only used to silence SSC warnings; actual timing is driven
// by calling ECAT_CheckTimer() every 1ms from drive/Timer.c)
...
///////////////////////////////////////////////////////////////////////////////
// SSC interrupt masking hooks
// Mask only the LAN9252 IRQ (XINT1) to protect ESC accesses.

#if defined(_9252_HW_) && (_9252_HW_ == 1)
#define PROTO
#else
#define PROTO extern
#endif
...
#define DISABLE_ESC_INT() ECAT_DisableEscInt()
#endif

#ifndef ENABLE_ESC_INT
#define ENABLE_ESC_INT() ECAT_EnableEscInt()
#endif
